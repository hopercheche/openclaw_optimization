...
export OPENCLAW_COMPOSE_PROJECT="${OPENCLAW_SCRIPT_COMPOSE_PROJECT:-openclaw-eval-locomo}"
export OPENCLAW_GATEWAY_PORT="${OPENCLAW_SCRIPT_GATEWAY_PORT:-18805}"
export OPENCLAW_EVAL_STATE_DIR="${OPENCLAW_SCRIPT_STATE_DIR:-$PROJECT_ROOT/openclaw_evalscope_cli/.openclaw-eval/parallel/locomo/state}"
export OPENCLAW_EVAL_SECRET_DIR="${OPENCLAW_SCRIPT_SECRET_DIR:-$PROJECT_ROOT/openclaw_evalscope_cli/.openclaw-eval/parallel/locomo/secrets}"
