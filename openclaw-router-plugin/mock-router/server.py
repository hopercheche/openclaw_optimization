...
class RouterInference:
    ...
    def get_model_comparison(self, pairs, model_a, model_b):
        for p in pairs:
    ...
    def route_with_cascade(self, feature, confidence_threshold=0.5):
        ...
        if confidence >= confidence_threshold:
            ...
            for model_key in CASCADE_ORDER[start_idx:]:
                ...
                comparison = self.get_model_comparison(pairs, model_key, current_best)
                if comparison > 0:
